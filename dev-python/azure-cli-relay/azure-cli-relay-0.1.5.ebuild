...
DESCRIPTION="Microsoft Azure CLI 'relay' command module"
HOMEPAGE="https://pypi.org/project/azure-cli-relay"
...
RDEPEND=">=dev-python/azure-mgmt-relay-0.2.0[${PYTHON_USEDEP}]
