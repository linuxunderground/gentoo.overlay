...
HOMEPAGE="https://pypi.python.org/pypi/azure-cli-redis"
SRC_URI="mirror://pypi/a/azure-cli-redis/${P}.tar.gz"

KEYWORDS="~amd64 ~x86 ~arm"
LICENSE="MIT"
SLOT="0"

RDEPEND=">=dev-python/azure-mgmt-redis-4.1.0[${PYTHON_USEDEP}]
