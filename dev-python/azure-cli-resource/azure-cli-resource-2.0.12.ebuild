...
HOMEPAGE="https://pypi.python.org/pypi/azure-cli-resource"
SRC_URI="mirror://pypi/a/azure-cli-resource/${P}.tar.gz"

KEYWORDS="~amd64 ~x86"
LICENSE="MIT"
SLOT="0"

RDEPEND=">=dev-python/azure-mgmt-resource-1.1.0[${PYTHON_USEDEP}]
