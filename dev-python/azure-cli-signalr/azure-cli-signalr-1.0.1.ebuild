...
DESCRIPTION="Microsoft Azure CLI signalr command module"
HOMEPAGE="https://pypi.org/project/azure-cli-signalr"
...
RDEPEND=">=dev-python/azure-mgmt-signalr-0.2.0[${PYTHON_USEDEP}]
