...
DESCRIPTION="Microsoft Azure CLI policyinsights command module"
HOMEPAGE="https://pypi.org/project/azure-cli-policyinsights"
...
RDEPEND=">=dev-python/azure-mgmt-policyinsights-0.2.0[${PYTHON_USEDEP}]
