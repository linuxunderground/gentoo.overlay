...
HOMEPAGE="https://pypi.python.org/pypi/azure-cli-dla"
SRC_URI="mirror://pypi/a/azure-cli-dla/${P}.tar.gz"

KEYWORDS="~amd64 ~x86"
LICENSE="MIT"
SLOT="0"

RDEPEND=">=dev-python/azure-mgmt-datalake-store-0.2.0[${PYTHON_USEDEP}]
	>=dev-python/azure-mgmt-datalake-analytics-0.2.0[${PYTHON_USEDEP}]
