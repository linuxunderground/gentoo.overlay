...
HOMEPAGE="https://pypi.python.org/pypi/azure-cli-backup"
SRC_URI="mirror://pypi/a/azure-cli-backup/${P}.tar.gz"

KEYWORDS="~amd64 ~x86"
LICENSE="MIT"
SLOT="0"

RDEPEND=">=dev-python/azure-mgmt-recoveryservicesbackup-0.1.1[${PYTHON_USEDEP}]
