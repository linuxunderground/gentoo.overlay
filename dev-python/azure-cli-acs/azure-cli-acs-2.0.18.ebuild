...
RDEPEND="dev-python/sshtunnel[${PYTHON_USEDEP}]
	...
	>=dev-python/azure-mgmt-containerservice-2.0.0[${PYTHON_USEDEP}]
	>=dev-python/azure-mgmt-compute-3.0.1[${PYTHON_USEDEP}]
	>=dev-python/azure-mgmt-authorization-0.30.0[${PYTHON_USEDEP}]
	>=dev-python/azure-graphrbac-0.30.0[${PYTHON_USEDEP}]
