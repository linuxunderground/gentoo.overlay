...
DESCRIPTION="Microsoft Azure CLI 'ams' Command Module"
HOMEPAGE="https://pypi.org/project/azure-cli-ams"
...
RDEPEND=">=dev-python/azure-graphrbac-0.53.0[${PYTHON_USEDEP}]
	>=dev-python/azure-mgmt-media-1.0.1[${PYTHON_USEDEP}]
