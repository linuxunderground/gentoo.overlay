...
HOMEPAGE="https://pypi.python.org/pypi/azure-cli-billing"
SRC_URI="mirror://pypi/a/azure-cli-billing/${P}.tar.gz"

KEYWORDS="~amd64 ~x86"
LICENSE="MIT"
SLOT="0"

RDEPEND="dev-python/azure-mgmt-billing[${PYTHON_USEDEP}]
