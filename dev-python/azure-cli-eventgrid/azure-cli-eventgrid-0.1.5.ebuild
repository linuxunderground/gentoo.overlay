...
HOMEPAGE="https://pypi.python.org/pypi/azure-cli-eventgrid"
SRC_URI="mirror://pypi/a/azure-cli-eventgrid/${P}.tar.gz"
...
RDEPEND="dev-python/six[${PYTHON_USEDEP}]
	>=dev-python/azure-mgmt-eventgrid-0.2.0[${PYTHON_USEDEP}]
