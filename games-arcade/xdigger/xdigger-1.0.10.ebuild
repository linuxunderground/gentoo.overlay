...
src_configure() {
	# must be hardcoded 
	sed -i -e '/XDIGGER_LIB_DIR/s:/usr/lib/X11:/usr/share/games:' configure.h
	sed -i -e '/XDIGGER_HISCORE_DIR/s:/var/X11R6:/var/games:' configure.h
	sed -i -e 's:/usr/lib/X11:/usr/share/games:' xdigger.man
	sed -i -e 's:/var/X11R6:/var/games:' xdigger.man
	#
	sed -i -e '/BINDIR/s:/usr/bin/X11:${GAMES_BINDIR}:' Imakefile
	sed -i -e '/ICONDIR/s:/usr/include/X11:/usr/share:' Imakefile
	sed -i -e 's:XDIGGER_HISCORE_DIR:${D}XDIGGER_HISCORE_DIR:' Imakefile
	xmkmf
}
